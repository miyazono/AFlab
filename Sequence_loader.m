...
% v7 - changed all MEMS marker code from latching to non-latching
% 
% ETM,IC created 20160203 
    ...
    methods
        ...
        function readout_step = make_readout_step(obj, burn_amplitude,...
            ...
            readout_step.num_loops = 1; 
             % the actually repeated version is commented because 40000 of anything makes the AWG ill
